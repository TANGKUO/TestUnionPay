...
import unionpay.sdk.BaseHttpSSLSocketFactory.TrustAnyHostnameVerifier;
...
public class HttpClient {
    ...
    private HttpURLConnection createConnectionGet(String encoding) throws ProtocolException {
        ...
        try {
            ...
            if (SDKConfig.getConfig().getProxy()) {

                SocketAddress sa = new InetSocketAddress(SDKConfig.getConfig().getHost(), Integer.parseInt(SDKConfig.getConfig().getPort()));
